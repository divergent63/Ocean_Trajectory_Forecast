...
def read_file(_path, delim="\t"):
    ...
    with open(_path, "r") as f:
        for line in f:
            ...
            line = [float(line[0].split(' ')[i]) for i in range(len(line[0].split(' ')))]
...
class TrajectoryDataset(Dataset):
    ...
    def __init__(
            ...
            for idx in range(0, num_sequences * self.skip + 1, skip):
                ...
                for _, ped_id in enumerate(peds_in_curr_seq):
                    ...
                    try:
                        ...
                        print('_idx: '+str(_idx)+'     ped_id: '+str(ped_id)+'     ValueError: (2,15), (2,16) not match')
        ...
        # except ValueError:
        #     print('ValueError: seq_list=[], can not concat')
