...
class RNN(nn.Module):
    ...
    def forward(self, x):
        ...
        # RuntimeError: input.size(-1) must be equal to input_size. Expected 6, got 2
        # Resolusion: x.shape: (seq_len, batch_size, input_size<输入序列的维度>); nn.LSTM(input_size, hidden_size, num_layers)
...
class CNN(nn.Module):
    def __init__(self, in_dim, n_class):
        ...
        self.conv = nn.Sequential(
            ...
            # (in, and out img_channels, kernel_size=(3, 3), stride=1, padding=1)
